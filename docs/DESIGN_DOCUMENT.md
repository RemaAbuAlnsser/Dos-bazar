...
# Next info request will be cache miss
curl http://localhost:5000/info/1
```

### Test Load Balancing
Check logs to see requests distributed across replicas.

## Conclusion

This implementation successfully adds **caching**, **replication**, and **consistency** mechanisms to the Bazar.com system. The design prioritizes simplicity and correctness while maintaining good performance through caching and load distribution.
